...
def passchange(data, request, template, route):
    ...
    if request.method == 'POST':
        ...
        if form.validate():
            ...
            if check_password_hash(user.password, form.old_password.data):
                ...
                if form.old_password.data == form.new_password.data:
                    ...
                    return render_template(template, route=route, data=data, form=form)
                ...
                if form.new_password.data == form.repeat_password.data:
                    ...
                    return render_template(template, route=route, data=data, form=PasswdChangeForm(), info=info)
        ...
        return render_template(template, route=route, data=data, form=PasswdChangeForm())
